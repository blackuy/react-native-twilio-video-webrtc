...
class TwilioRemotePreview extends Component {
  ...
  render() {
    return <TWRemotePreview {...this.props}>{this.props.children}</TWRemotePreview> // onConnect={this._onConnect}
  }
}
...
var TWRemotePreview = requireNativeComponent('TWRemotePreview', TwilioRemotePreview)
